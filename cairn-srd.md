...
次に、[**キャラクター属性**](#キャラクター属性d10)表で外見、喋り方、癖、 信念、評判などを決める。
...
例を展開
 ...
 イネスはキャラクターの**頑健**値のために3d6を振り、出目は**2**、**4**、**6**で合計**12**となる。つづいて**敏捷**に**9**、**意思**に**13**を得る。**12**と**9**を入れ替えて、作成したキャラクターの能力値は**頑健9**、**敏捷12**、**意思13**だ。
</details>
